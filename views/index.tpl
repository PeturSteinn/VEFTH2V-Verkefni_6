...
<body>
  ...
  <section class="wrapper">
    ...
    <div class="brief-nav">
      <h3>Hvar er ódýrasta eldsneytið?</h3>
      <div class="fuel-results">
        <p>Bensín:&nbsp;{{odyrt_bensin['bensin95']}}&nbsp;&nbsp;&nbsp;&nbsp;Fyrirtæki:&nbsp;{{odyrt_bensin['company']}}</p>
        <p>Diesel:&nbsp;&nbsp;{{odyrt_diesel['diesel']}}&nbsp;&nbsp;&nbsp;&nbsp;Fyrirtæki:&nbsp;{{odyrt_diesel['company']}}</p>
        <p class="last-update">Síðast uppfært: {{lastPriceCheck[0]}} kl: {{lastPriceCheck[1]}}</p>
      </div>
      <hr>
      <ul>
        % for i in all_stations:
        <li><a href="/stod/{{i['company']}}">&nbsp;&nbsp;&nbsp;&nbsp;{{i['company']}}&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
        % end
      </ul>
    </div>
  </section>
